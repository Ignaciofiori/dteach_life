...
# Reunión No.3: Martes 6 de Diciembre (asincrónica):busts_in_silhouette:  
## 1. Qué se hizo ayer:
...
# Reunión No.4: Lunes 12 de Diciembre (virtual):anchor:  
## 1. Qué se hizo ayer:
...
# Reunión No.5: Lunes 20 de Diciembre (virtual):clap:
## 1. Qué se hizo ayer:
...
# Reunión No.6: Lunes 29 de Diciembre (virtual):man_technologist:  
## 1. Qué se hizo ayer:
...
# Reunión No.7: -Martes 10 de Enero (virtual):boy::boy::boy::woman:  
## 1. Qué se hizo ayer:
### 1.1. Se analizaron las actividades pendientes al cierre del sprint No.6.
### 1.2. Se analizaron las actividades establecidas para el sprint No.7, el cual se lanzará el 11 de Enero.
## 2. Se encontró algún impedimento?:
### 2.1. La conexión con la base de datos, la cual se debía configurar de manera correcta para poder hacer correr la aplicación.
## 3. Qué se va a hacer hoy:
### 3.1. Ir modificando los formularios con los ajustes solicitados para el sprint 7.

# Reunión No.8: -Martes 24 de Enero (virtual):point_down:	  
## 1. Qué se hizo ayer:
### 1.1. Cambios en la aplicación que contenga las instrucciones del Sprint 7.
## 2. Se encontró algún impedimento?:
### 2.1. Se ha complicado las validaciones y el almacenamiento de los datos del usuario en el momento de volver a editar la información.
## 3. Qué se va a hacer hoy:
### 3.1. Solucionar dichos errores que se están presentando durante la ejecución de la aplicación.
### 3.2. Realizar ajustes en la base de datos, teniendo en cuenta las observaciones de los profesores, y que permitan corregir posibles fallos en la aplicación en cuanto a la creación y borrado de usuarios.

# Reunión No.9: -Martes 7 de Febrero (virtual):sunrise_over_mountains:  
## 1. Qué se hizo ayer:
### 1.1. Finiquitar lo solicitado para el Sprint 7.
## 2. Se encontró algún impedimento?:
### 2.1. La sincronización de la información en GitHub.
## 3. Qué se va a hacer hoy:
### 3.1. Revisión de las relaciones establecidas en el diagrama de base de datos.
...
### 1.3. Trabajar sobre lo solicitado en el sprint 8 (Apis + REACT).
### 1.4. Actualizar el tablero de actividades y el Retro
## 2. Se encontró algún impedimento?:
### 2.1. La sincronización de la información en GitHub.
## 3. Qué se va a hacer hoy:
### 3.1. Agregar funcionalidad a la barra de búsqueda.
### 3.2. Agregar funcionalidaades en el main index para visualizar las especialidades
### 3.3. Seguir trabajando en darle estilo a la aplicación.
